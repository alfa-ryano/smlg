 ...
 * @generated
 */
public class EomlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EomlPackage.EOML: {
				EOML eoml = (EOML)theEObject;
				T result = caseEOML(eoml);
			...
			case EomlPackage.LINK: {
				...
				if (result == null) result = caseEdge(link);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EOML</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EOML</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEOML(EOML object) {
		return null;
	}
