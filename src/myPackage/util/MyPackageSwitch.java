 ...
 * @generated
 */
public class MyPackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MyPackagePackage.SHORTCUT: {
			...
			case MyPackagePackage.SYNC: {
				Sync sync = (Sync)theEObject;
				T result = caseSync(sync);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MyPackagePackage.FILE: {
