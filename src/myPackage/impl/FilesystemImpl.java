 ...
 * </p>
 * <ul>
 *   <li>{@link myPackage.impl.FilesystemImpl#getDrives <em>Drives</em>}</li>
 *   <li>{@link myPackage.impl.FilesystemImpl#getSyncs <em>Syncs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilesystemImpl extends EObjectImpl implements Filesystem {
	...
	protected EClass eStaticClass() {
		return MyPackagePackage.Literals.FILESYSTEM;
	}
	...
	public EList<Drive> getDrives() {
		if (drives == null) {
			drives = new EObjectContainmentEList<Drive>(Drive.class, this, MyPackagePackage.FILESYSTEM__DRIVES);
		}
		return drives;
	}
	...
	public EList<Sync> getSyncs() {
		if (syncs == null) {
			syncs = new EObjectContainmentEList<Sync>(Sync.class, this, MyPackagePackage.FILESYSTEM__SYNCS);
		}
		return syncs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MyPackagePackage.FILESYSTEM__DRIVES:
				return ((InternalEList<?>)getDrives()).basicRemove(otherEnd, msgs);
			case MyPackagePackage.FILESYSTEM__SYNCS:
