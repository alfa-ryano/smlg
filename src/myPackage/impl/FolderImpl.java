 ...
 * </p>
 * <ul>
 *   <li>{@link myPackage.impl.FolderImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FolderImpl extends FileImpl implements Folder {
	...
	protected EClass eStaticClass() {
		return MyPackagePackage.Literals.FOLDER;
	}
	...
	public EList<File> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<File>(File.class, this, MyPackagePackage.FOLDER__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MyPackagePackage.FOLDER__CONTENTS:
