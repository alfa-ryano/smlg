...
public class TreePackageImpl extends EPackageImpl implements TreePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTree_Label(), ecorePackage.getEString(), "label", "1234", 0, 1, Tree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
