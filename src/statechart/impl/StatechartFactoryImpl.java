...
public class StatechartFactoryImpl extends EFactoryImpl implements StatechartFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StatechartPackage.EDGE: return createEdge();
			case StatechartPackage.TRANSITION: return createTransition();
			case StatechartPackage.LINK: return createLink();
			case StatechartPackage.STATE: return createState();
			case StatechartPackage.NOTE: return createNote();
			case StatechartPackage.START: return createStart();
			case StatechartPackage.END: return createEnd();
			default:
