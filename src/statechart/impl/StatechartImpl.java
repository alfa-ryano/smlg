 ...
 * </p>
 * <ul>
 *   <li>{@link statechart.impl.StatechartImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatechartImpl extends EObjectImpl implements Statechart {
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this, StatechartPackage.STATECHART__ENTITIES);
		}
		return entities;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatechartPackage.STATECHART__ENTITIES:
