...
public class StatechartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatechartPackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatechartPackage.NODE: {
			...
			case StatechartPackage.NOTE: {
				Note note = (Note)theEObject;
				T result = caseNote(note);
				if (result == null) result = caseNode(note);
				if (result == null) result = caseEntity(note);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatechartPackage.START: {
