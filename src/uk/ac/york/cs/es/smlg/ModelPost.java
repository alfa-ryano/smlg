...
public class ModelPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// CollaborationmodelPackage collaborationModelPackage =
			// (CollaborationmodelPackage)
			// modellingPackage.getField("eINSTANCE").get(modellingPackage);
			...
			String path = "D:/model.xmi";
			Resource currentResource = currentResourceSet.createResource(URI.createFileURI(path));
			// Resource currentResource =
			// currentResourceSet.createResource(URI.createURI(path));
			currentResource.load(new ByteArrayInputStream(xmi.getBytes()), null);
